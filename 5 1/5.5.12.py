...
def znajdz_miejsce_zerowe_rekurencyjnie(a,b,e,tab):
    srodek = (a+b)/2
    ...
    if obliczanie_wartosci_funkcji(tab,a)*obliczanie_wartosci_funkcji(tab,srodek) < 0:
        return znajdz_miejsce_zerowe_rekurencyjnie(a,srodek,e,tab)
    else:
        return znajdz_miejsce_zerowe_rekurencyjnie(srodek, b, e, tab)
...
b= float(input())
e= float(input())
print(znajdz_miejsce_zerowe_rekurencyjnie(a,b,e,tablica_wspolczynnikow))